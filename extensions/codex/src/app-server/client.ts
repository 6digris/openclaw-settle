...
import { CodexAppServerLineParser, redactCodexAppServerLinePreview } from "./client-line-parser.js";
...
export class CodexAppServerClient {
  ...
  private readonly lineParser = new CodexAppServerLineParser((message) =>
  ...
  private constructor(child: CodexAppServerTransport) {
    ...
    this.lines.on("line", (line) => this.lineParser.handleLine(line));
