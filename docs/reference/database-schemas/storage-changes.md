...
Member changes publish replacement identities after commit, so revocation is
visible even while display rows are still dirty. The group catalog similarly
