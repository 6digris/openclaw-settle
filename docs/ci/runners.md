...
| `blacksmith-16vcpu-ubuntu-2404` | Trusted automatic hybrid first-attempt preflight, main CI build artifacts, automatic QA Smoke, full CLI bins, Docker seed, Control UI E2E, lint, dependencies, test types, core test-type stripes, extension package boundaries, and runtime topology architecture                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `blacksmith-32vcpu-ubuntu-2404` | Two-child compact bins, Blacksmith tooling and agent-support bins, hybrid unified and SDK declaration compiler fixture bins, real-Gateway E2E, separate npm release preflight and reusable release/E2E workflows                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
360-second aggregate budget. The 32-class is the measured allocation that meets
...
Testbox comparison at the same source, memory, starting caches and case inventory,
