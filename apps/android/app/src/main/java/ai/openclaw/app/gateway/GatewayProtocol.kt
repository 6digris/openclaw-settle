...
enum class GatewayMethod(
  ...
  WorktreesInventory("worktrees.inventory"),
  WorktreesMovePreview("worktrees.move.preview"),
  WorktreesMove("worktrees.move"),
  WorktreesMoveVerify("worktrees.move.verify"),
