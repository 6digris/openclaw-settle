...
struct OpenClawTypographyTests {
    @Test func `background task text keeps branded typography`() throws {
        let source = try String(contentsOf: Self.sourceURL("Design/BackgroundTasksScreen.swift"), encoding: .utf8)
