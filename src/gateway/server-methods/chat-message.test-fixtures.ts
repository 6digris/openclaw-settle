// Raw chat attachments and message inspection share the directive suite’s fixture bytes.
...
export function extractFirstTextBlock(payload: unknown): string | undefined {
