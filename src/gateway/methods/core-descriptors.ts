...
export const CORE_GATEWAY_METHOD_SPECS = [
  ...
  ["worktrees.inventory", "worktrees", "operator.admin", "2026.9"],
  ["worktrees.move.preview", "worktrees", "operator.admin", "2026.9"],
  ["worktrees.move", "worktrees", "operator.admin", "2026.9", CONTROL_PLANE_WRITE],
  ["worktrees.move.verify", "worktrees", "operator.admin", "2026.9"],
