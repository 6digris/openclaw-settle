...
import { SESSION_READ_METHOD_SCOPES as SESSION_READ } from "../../shared/session-method-scopes-base.js";
...
export const CORE_GATEWAY_METHOD_SPECS = [
  ...
  ["models.list", "models", SESSION_READ["models.list"], "<=2026.7", { startup: true }],
  ...
  ["users.self", "users", SESSION_READ["users.self"], "<=2026.7"],
  ...
  ["agents.list", "agents", SESSION_READ["agents.list"], "<=2026.7"],
  ...
  ["sessions.list", "sessions-read", SESSION_READ["sessions.list"], "<=2026.7", { startup: true }],
  [
    "sessions.subscribe",
    "sessions-subscriptions",
    SESSION_READ["sessions.subscribe"],
    "<=2026.7",
    { startup: true },
  ],
  [
    ...
    "sessions-subscriptions",
    SESSION_READ["sessions.messages.subscribe"],
    "<=2026.7",
  ],
  [
    "sessions.messages.unsubscribe",
    "sessions-subscriptions",
    SESSION_READ["sessions.messages.unsubscribe"],
    "<=2026.7",
  ],
  [
    "sessions.viewers.set",
    "sessions-subscriptions",
    SESSION_READ["sessions.viewers.set"],
    "2026.7",
  ],
  ["sessions.preview", "sessions-read", SESSION_READ["sessions.preview"], "<=2026.7"],
  ["sessions.describe", "sessions-read", SESSION_READ["sessions.describe"], "<=2026.7"],
  ...
  ["sessions.groups.list", "sessions-groups", SESSION_READ["sessions.groups.list"], "<=2026.7"],
  ...
  ["agent.identity.get", "agent-identity", SESSION_READ["agent.identity.get"], "<=2026.7"],
  ["agent.wait", "agent", "operator.write", "<=2026.7", { startup: true }],
  ["chat.history", "chat", SESSION_READ["chat.history"], "<=2026.7", { startup: true }],
  ["chat.startup", "chat", SESSION_READ["chat.startup"], "<=2026.7", { startup: true }],
  ["chat.metadata", "chat", SESSION_READ["chat.metadata"], "<=2026.7", { startup: true }],
  ["chat.message.get", "chat", SESSION_READ["chat.message.get"], "<=2026.7", { startup: true }],
  ...
  ["sessions.get", "sessions-read", SESSION_READ["sessions.get"], "<=2026.7", { advertise: false }],
  [
    "sessions.resolve",
    "sessions-read",
    SESSION_READ["sessions.resolve"],
    "<=2026.7",
    { advertise: false },
  ],
  ...
  ["sessions.search", "sessions-read", SESSION_READ["sessions.search"], "<=2026.7"],
  [
    "sessions.dispatch",
    "sessions-dispatch",
    "dynamic",
  ...
  [
    ...
    SESSION_READ["session.suggestions.list"],
    "2026.7",
  ],
  ...
  ["projects.list", "projects", SESSION_READ["projects.list"], "2026.8"],
  ...
  ["users.prefs.get", "users", SESSION_READ["users.prefs.get"], "2026.8"],
  ...
  ["progressCard.get", "progress-card", SESSION_READ["progressCard.get"], "2026.8"],
  ...
  ["themes.list", "themes", SESSION_READ["themes.list"], "2026.9"],
  ["themes.get", "themes", SESSION_READ["themes.get"], "2026.9"],
