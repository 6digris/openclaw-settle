...
export const CORE_GATEWAY_METHOD_SPECS = [
  ...
  ["models.list", "models", "operator.sessions.read", "<=2026.7", { startup: true }],
  ...
  ["chat.startup", "chat", "operator.sessions.read", "<=2026.7", { startup: true }],
  ["chat.metadata", "chat", "operator.sessions.read", "<=2026.7", { startup: true }],
