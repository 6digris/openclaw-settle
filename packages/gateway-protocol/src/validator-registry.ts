...
export const validateDiagnosticsVitalsParams = compile(S.DiagnosticsVitalsParamsSchema);
export const validateDiagnosticsVitalsResult = compile(S.DiagnosticsVitalsResultSchema);
