...
export const validateWorktreesInventoryParams = compile(S.WorktreesInventoryParamsSchema);
export const validateWorktreesMovePreviewParams = compile(S.WorktreesMovePreviewParamsSchema);
export const validateWorktreesMoveParams = compile(S.WorktreesMoveParamsSchema);
export const validateWorktreesMoveVerifyParams = compile(S.WorktreesMoveVerifyParamsSchema);
