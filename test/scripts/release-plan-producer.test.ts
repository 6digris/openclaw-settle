...
`,
  ...
  it("matches the exact current publisher inventory: 99 npm and 95 ClawHub packages", () => {
    ...
    expect(npmPackages).toHaveLength(99);
    expect(clawHubPackages).toHaveLength(95);
