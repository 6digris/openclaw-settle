...
export const databaseWorkerCoreFormerFastKinds = new Map([
  ...
  ["src/infra/device-pairing-approval-policy.test.ts", "unitFast"],
  ["src/infra/device-pairing-churn.test.ts", "unitFast"],
  ["src/infra/device-pairing-node.test.ts", "unitFast"],
  ["src/infra/device-pairing-prune.test.ts", "unitFast"],
