  ...
  chat: {
    ...
    composer: {
      ...
      menu: {
        ...
        skillsScope: "For this session only",
        refreshFailed: "Session settings were saved, but refreshing the session failed: {error}",
        searchSkills: "Search skills…",
        skillsSummary: "{enabled} of {count} enabled",
        noSkillMatches: "No matching skills.",
        skillDetails: "Skill details",
        skillEnabledLabel: "Enable {name} for this session",
        skillInherited: "Using the agent default.",
        skillOverridden: "Changed for this session.",
        skillReset: "Use agent default",
