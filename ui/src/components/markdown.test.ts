...
describe("toSanitizedMarkdownHtml", () => {
  ...
  it("strips scripts and unsafe links", () => {
    ...
    expect(html).toBe(
      '&lt;script&gt;alert(1)&lt;/script&gt;\n\n<p>x</p>\n<p><a href="https://example.com" rel="noreferrer noopener" target="_blank">ok<openclaw-external-link></openclaw-external-link></a></p>\n',
    );
  });
  ...
  describe("task lists", () => {
    ...
    it("renders links inside task items", () => {
      ...
      expect(html).toBe(
        '<ul class="contains-task-list">\n<li class="task-list-item"><input class="task-list-item-checkbox" disabled="" type="checkbox"> Task with <a href="https://example.com" rel="noreferrer noopener" target="_blank">link<openclaw-external-link></openclaw-external-link></a></li>\n</ul>\n',
      );
    });
  ...
  describe("security", () => {
    ...
    it("rewrites docs-root links to the public docs host", () => {
      ...
      expect(html).toBe(
        '<p><a href="https://docs.openclaw.ai/concepts/agent-workspace" rel="noreferrer noopener" target="_blank">workspace<openclaw-external-link></openclaw-external-link></a> <a href="https://docs.openclaw.ai/automation/hooks#session-memory" rel="noreferrer noopener" target="_blank">hooks<openclaw-external-link></openclaw-external-link></a> <a href="https://docs.openclaw.ai/channels/telegram?tab=setup" rel="noreferrer noopener" target="_blank">telegram<openclaw-external-link></openclaw-external-link></a> <a href="https://docs.openclaw.ai/telegram" rel="noreferrer noopener" target="_blank">shortlink<openclaw-external-link></openclaw-external-link></a> <a href="https://docs.openclaw.ai/openai" rel="noreferrer noopener" target="_blank">openai<openclaw-external-link></openclaw-external-link></a> <a href="https://docs.openclaw.ai/images" rel="noreferrer noopener" target="_blank">images<openclaw-external-link></openclaw-external-link></a> <a href="https://docs.openclaw.ai/groups" rel="noreferrer noopener" target="_blank">groups<openclaw-external-link></openclaw-external-link></a> <a href="https://docs.openclaw.ai/nodes/camera" rel="noreferrer noopener" target="_blank">camera<openclaw-external-link></openclaw-external-link></a> <a href="https://docs.openclaw.ai/platforms/macos" rel="noreferrer noopener" target="_blank">macOS<openclaw-external-link></openclaw-external-link></a> <a href="https://docs.openclaw.ai/cli/sessions" rel="noreferrer noopener" target="_blank">cliSessions<openclaw-external-link></openclaw-external-link></a> <a href="https://docs.openclaw.ai/tools/skills" rel="noreferrer noopener" target="_blank">toolSkills<openclaw-external-link></openclaw-external-link></a> <a href="https://docs.openclaw.ai/plugins/reference/diffs" rel="noreferrer noopener" target="_blank">pluginDocs<openclaw-external-link></openclaw-external-link></a> <a href="https://docs.openclaw.ai/prose" rel="noreferrer noopener" target="_blank">prose<openclaw-external-link></openclaw-external-link></a> <a href="https://docs.openclaw.ai/channels/access-groups" rel="noreferrer noopener" target="_blank">access<openclaw-external-link></openclaw-external-link></a></p>\n',
      );
    });
